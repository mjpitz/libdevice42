...
// NewGetBuildingsParams creates a new GetBuildingsParams object
// with the default values initialized.
func NewGetBuildingsParams() *GetBuildingsParams {
	var ()
	return &GetBuildingsParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewGetBuildingsParamsWithTimeout creates a new GetBuildingsParams object
...
// NewGetBuildingsParamsWithContext creates a new GetBuildingsParams object
...
// NewGetBuildingsParamsWithHTTPClient creates a new GetBuildingsParams object
...
/*GetBuildingsParams contains all the parameters to send to the API endpoint
for the get buildings operation typically these are written to a http.Request
*/
...
func (o *GetBuildingsParams) WithContext(ctx context.Context) *GetBuildingsParams {
	o.SetContext(ctx)
	return o
}
