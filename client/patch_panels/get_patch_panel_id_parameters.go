...
// NewGetPatchPanelIDParams creates a new GetPatchPanelIDParams object
// with the default values initialized.
func NewGetPatchPanelIDParams() *GetPatchPanelIDParams {
	var ()
	return &GetPatchPanelIDParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewGetPatchPanelIDParamsWithTimeout creates a new GetPatchPanelIDParams object
...
// NewGetPatchPanelIDParamsWithContext creates a new GetPatchPanelIDParams object
...
// NewGetPatchPanelIDParamsWithHTTPClient creates a new GetPatchPanelIDParams object
...
/*GetPatchPanelIDParams contains all the parameters to send to the API endpoint
for the get patch panel ID operation typically these are written to a http.Request
*/
...
func (o *GetPatchPanelIDParams) WithContext(ctx context.Context) *GetPatchPanelIDParams {
	o.SetContext(ctx)
	return o
}
...
func (o *GetPatchPanelIDParams) WithID(id int64) *GetPatchPanelIDParams {
	o.SetID(id)
	return o
}
