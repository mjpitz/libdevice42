...
// NewPostPdusPortsParams creates a new PostPdusPortsParams object
// with the default values initialized.
func NewPostPdusPortsParams() *PostPdusPortsParams {
	var ()
	return &PostPdusPortsParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewPostPdusPortsParamsWithTimeout creates a new PostPdusPortsParams object
...
// NewPostPdusPortsParamsWithContext creates a new PostPdusPortsParams object
...
// NewPostPdusPortsParamsWithHTTPClient creates a new PostPdusPortsParams object
...
*/
type PostPdusPortsParams struct {
	...
	*/
	DeviceID *string
	/*Name
	  PDU port name, typically the PDU port number when autodiscovered.
	...
	*/
	PduID *string
	/*PortType
	  Verbose name of the port type. Must exist already.
