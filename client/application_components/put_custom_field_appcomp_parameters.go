...
// NewPutCustomFieldAppcompParams creates a new PutCustomFieldAppcompParams object
// with the default values initialized.
func NewPutCustomFieldAppcompParams() *PutCustomFieldAppcompParams {
	var ()
	return &PutCustomFieldAppcompParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewPutCustomFieldAppcompParamsWithTimeout creates a new PutCustomFieldAppcompParams object
...
// NewPutCustomFieldAppcompParamsWithContext creates a new PutCustomFieldAppcompParams object
...
// NewPutCustomFieldAppcompParamsWithHTTPClient creates a new PutCustomFieldAppcompParams object
...
/*PutCustomFieldAppcompParams contains all the parameters to send to the API endpoint
for the put custom field appcomp operation typically these are written to a http.Request
*/
...
func (o *PutCustomFieldAppcompParams) WithTimeout(timeout time.Duration) *PutCustomFieldAppcompParams {
...
func (o *PutCustomFieldAppcompParams) WithContext(ctx context.Context) *PutCustomFieldAppcompParams {
	o.SetContext(ctx)
	return o
}
...
func (o *PutCustomFieldAppcompParams) WithHTTPClient(client *http.Client) *PutCustomFieldAppcompParams {
...
func (o *PutCustomFieldAppcompParams) WithID(id *string) *PutCustomFieldAppcompParams {
	o.SetID(id)
	return o
}
...
func (o *PutCustomFieldAppcompParams) WithKey(key string) *PutCustomFieldAppcompParams {
	o.SetKey(key)
	return o
}
...
func (o *PutCustomFieldAppcompParams) WithName(name *string) *PutCustomFieldAppcompParams {
	o.SetName(name)
	return o
}
...
func (o *PutCustomFieldAppcompParams) WithNotes(notes *string) *PutCustomFieldAppcompParams {
	o.SetNotes(notes)
	return o
}
...
func (o *PutCustomFieldAppcompParams) SetShowOnChart(showOnChart *string) {
	o.ShowOnChart = showOnChart
}

// WithType adds the typeVar to the put custom field appcomp params
func (o *PutCustomFieldAppcompParams) WithType(typeVar *string) *PutCustomFieldAppcompParams {
	o.SetType(typeVar)
	return o
}
...
func (o *PutCustomFieldAppcompParams) WithValue(value *string) *PutCustomFieldAppcompParams {
	o.SetValue(value)
	return o
}
...
func (o *PutCustomFieldAppcompParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.ShowOnChart != nil {

		// form param show_on_chart
		var frShowOnChart string
		if o.ShowOnChart != nil {
			frShowOnChart = *o.ShowOnChart
		}
		fShowOnChart := frShowOnChart
		if fShowOnChart != "" {
			if err := r.SetFormParam("show_on_chart", fShowOnChart); err != nil {
				return err
			}
		}
