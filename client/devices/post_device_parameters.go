...
// NewPostDeviceParamsWithTimeout creates a new PostDeviceParams object
...
// NewPostDeviceParamsWithContext creates a new PostDeviceParams object
...
// NewPostDeviceParamsWithHTTPClient creates a new PostDeviceParams object
...
/*PostDeviceParams contains all the parameters to send to the API endpoint
for the post device operation typically these are written to a http.Request
*/
