...
// NewGetIPAMvrfgroupParams creates a new GetIPAMvrfgroupParams object
// with the default values initialized.
func NewGetIPAMvrfgroupParams() *GetIPAMvrfgroupParams {

	return &GetIPAMvrfgroupParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewGetIPAMvrfgroupParamsWithTimeout creates a new GetIPAMvrfgroupParams object
...
// NewGetIPAMvrfgroupParamsWithContext creates a new GetIPAMvrfgroupParams object
...
// NewGetIPAMvrfgroupParamsWithHTTPClient creates a new GetIPAMvrfgroupParams object
...
/*GetIPAMvrfgroupParams contains all the parameters to send to the API endpoint
for the get IP a mvrfgroup operation typically these are written to a http.Request
*/
...
func (o *GetIPAMvrfgroupParams) WithContext(ctx context.Context) *GetIPAMvrfgroupParams {
	o.SetContext(ctx)
	return o
}
