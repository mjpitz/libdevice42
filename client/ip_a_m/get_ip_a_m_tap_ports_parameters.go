...
// NewGetIPAMTapPortsParams creates a new GetIPAMTapPortsParams object
// with the default values initialized.
func NewGetIPAMTapPortsParams() *GetIPAMTapPortsParams {
	var ()
	return &GetIPAMTapPortsParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewGetIPAMTapPortsParamsWithTimeout creates a new GetIPAMTapPortsParams object
...
// NewGetIPAMTapPortsParamsWithContext creates a new GetIPAMTapPortsParams object
...
// NewGetIPAMTapPortsParamsWithHTTPClient creates a new GetIPAMTapPortsParams object
...
/*GetIPAMTapPortsParams contains all the parameters to send to the API endpoint
for the get IP a m tap ports operation typically these are written to a http.Request
*/
...
func (o *GetIPAMTapPortsParams) WithContext(ctx context.Context) *GetIPAMTapPortsParams {
	o.SetContext(ctx)
	return o
}
...
func (o *GetIPAMTapPortsParams) WithID(id *string) *GetIPAMTapPortsParams {
	o.SetID(id)
	return o
}
