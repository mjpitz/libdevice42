...
// NewGetIPAMvlansIDParams creates a new GetIPAMvlansIDParams object
// with the default values initialized.
func NewGetIPAMvlansIDParams() *GetIPAMvlansIDParams {
	var ()
	return &GetIPAMvlansIDParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewGetIPAMvlansIDParamsWithTimeout creates a new GetIPAMvlansIDParams object
...
// NewGetIPAMvlansIDParamsWithContext creates a new GetIPAMvlansIDParams object
...
// NewGetIPAMvlansIDParamsWithHTTPClient creates a new GetIPAMvlansIDParams object
...
/*GetIPAMvlansIDParams contains all the parameters to send to the API endpoint
for the get IP a mvlans id operation typically these are written to a http.Request
*/
...
func (o *GetIPAMvlansIDParams) WithContext(ctx context.Context) *GetIPAMvlansIDParams {
	o.SetContext(ctx)
	return o
}
...
func (o *GetIPAMvlansIDParams) WithID(id int64) *GetIPAMvlansIDParams {
	o.SetID(id)
	return o
}
